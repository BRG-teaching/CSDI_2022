...
* Finally, we will create a line in the form diagram representing the line of action of the resultant. And we will choose the anchor point of the resultant using a variable from Grasshopper (z).&#x20;
